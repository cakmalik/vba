<template>
  <div class="min-h-screen overflow-hidden w-full flex flex-col bg-white" :style="{ backgroundImage: `url(${bgUrl})` }">
    ...
    <div class="flex-1 relative z-10">
      <div class="grid grid-cols-2 p-12 gap-6">
        ...
        <a href="https://drive.google.com/file/d/1k-1s63ZwiobMRip8CauNRQGyOEq85tjL/view?usp=sharing"
          class="bg-white rounded-xl h-32 w-full shadow-md flex flex-col items-center justify-center gap-2">
          <PhMapTrifold :size="42" color="oklch(49.6% 0.265 301.924)" />
          <span class="text-neutral-500 text-center">Site Plan VBA</span>
        </a>
